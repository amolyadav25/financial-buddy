...
public class LBSelfEmployedBusinessFragment extends Fragment {

    public static LBSelfEmployedBusinessFragment newInstance() {
        return new LBSelfEmployedBusinessFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        professionalImage.setImageDrawable(getContext().getResources().getDrawable(R.drawable.self_employed_business_banr));
        ...
        nextButtonForQuestions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (companyTypeSpinner.getSelectedItem().toString().equalsIgnoreCase(companyTypeHint)){
                    showSnackBar("Select Indusrty Type !!", R.color.red);
                }
        ...
        if (!mSharedPreferences.getString(AppConstant.LOAN_STATUS_TRACKER, "").trim().equalsIgnoreCase("8")) {
            ...
            editor.putString(AppConstant.LOAN_STATUS_TRACKER, "7B");
            editor.apply();
        }
