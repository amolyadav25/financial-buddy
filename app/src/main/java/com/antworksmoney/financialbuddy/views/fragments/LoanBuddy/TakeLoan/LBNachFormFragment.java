...
public class LBNachFormFragment extends Fragment {

    public LBNachFormFragment() {
        // Required empty public constructor
    }


    public static LBNachFormFragment newInstance(JSONObject inputObject) {
        mRJsonObject = inputObject;
        return new LBNachFormFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView =  inflater.inflate(R.layout.fragment_nach_form, container, false);
        ...
        acceptLoanAgreementButton.setOnClickListener(view ->
                showSnackBar("Nach Uploaded successfully !!", R.color.green));
